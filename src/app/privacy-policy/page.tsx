...
export const metadata = {
  title: "Политика в отношении обработки персональных данных | Купить Картину",
  description:
    "Политика конфиденциальности и обработки персональных данных сайта kupitkartinu.ru",
};
    ...
    <div className="layout-wrapper py-30 min-h-screen">
      ...
      <div className=" text-base font-normal leading-relaxed">
        ...
        <section className="mb-8">
          <h2 className="text-base font-gibb mb-4">1. Общие положения</h2>
          <p className="mb-4">
            ...
            Малкина Наталья Геннадьевна (далее — Оператор).
          </p>
          <p className="mb-4">
          ...
          <p className="mb-4">
            ...
            https://kupitkartinu.ru.
          </p>
        </section>

        {/* 2. Основные понятия */}
        <section className="mb-8">
          <h2 className="text-base font-gibb mb-4">
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">3.1. Оператор имеет право:</p>
          <p className="mb-4">
          ...
          <p className="mb-4">3.2. Оператор обязан:</p>
          <p className="mb-4">
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">4.1. Субъекты персональных данных имеют право:</p>
          <p className="mb-4">
          ...
          <p className="mb-4">4.2. Субъекты персональных данных обязаны:</p>
          <p className="mb-4">
        ...
        <section className="mb-8">
          ...
          <div className="mb-4">
            ...
            <p className="mb-2">
              <strong>Персональные данные:</strong> философские убеждения
            </p>
            <p className="mb-2">
            ...
            <p className="mb-2">
              <strong>Виды обработки персональных данных:</strong> Передача
              персональных данных
            </p>
          </div>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            ...
            Оператора info@kupitkartinu.ru с пометкой «Актуализация персональных
            данных».
          </p>
          <p className="mb-4">
            ...
            info@kupitkartinu.ru с пометкой «Отзыв согласия на обработку
            персональных данных».
          </p>
          <p className="mb-4">
        ...
        <section className="mb-8 ">
          ...
          <p className="mb-4">
            ...
            к Оператору с помощью электронной почты info@kupitkartinu.ru.
          </p>
          <p className="mb-4">
          ...
          <p className="mb-4">
            ...
            сети Интернет по адресу https://kupitkartinu.ru/privacy-policy.
          </p>
        </section>
